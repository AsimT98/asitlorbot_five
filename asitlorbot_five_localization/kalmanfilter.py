...
class KalmanFilter(Node):
    ...
    def __init__(self):
        ...
        self.lidar_sub_ = self.create_subscription(LaserScan, "laser_controller/out", self.lidarCallback, 10)
    ...
    def lidarCallback(self, laser_controller):
        # Store the measurement update
        self.lidar_angular_z_ = laser_controller.angular_velocity.z


    def measurementUpdate(self):
        self.mean_ = (self.measurement_variance_ * self.mean_ + self.variance_ * self.lidar_angular_z_) \
